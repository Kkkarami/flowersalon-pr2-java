...
public class MainController {
  ...
  private final AccessoryService accessoryService =
      new AccessoryServiceImpl(new AccessoryRepositoryImpl());

  private final OrderService orderService =
      new OrderServiceImpl(new OrderRepositoryImpl(), new OrderItemRepositoryImpl());
  ...
  public void initialize() {
    ...
    createOrderButton.setOnAction(e -> openCreateOrderWindow());
  ...
  private void openCreateOrderWindow() {
    ...
    try {
      ...
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/create-order-view.fxml"));

      Parent root = loader.load();

      Stage currentStage = (Stage) mainTableView.getScene().getWindow();
  ...
  private void handleEditOrder() {
    ...
    Order selectedOrder = (Order) mainTableView.getSelectionModel().getSelectedItem();
