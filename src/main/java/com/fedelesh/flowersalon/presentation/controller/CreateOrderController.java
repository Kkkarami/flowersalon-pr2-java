...
public class CreateOrderController {
    ...
    @FXML
    private Pane bouquetWorkspace;

    @FXML
    private TableColumn<Flower, String> flowerImageColumn;
    ...
    @FXML
    private TableColumn<Bouquet, String> bouquetImageColumn;
    ...
    @FXML
    private TableColumn<Accessory, String> accessoryImageColumn;
