...
public class CreateOrderController {
  ...
  private final CreateOrderViewModel viewModel =
      new CreateOrderViewModel(LoginController.authService);
  ...
  private void handleAddFlower() {
    ...
    viewModel.addFlower(flowersTableView.getSelectionModel().getSelectedItem());
  }

  @FXML
  private void handleAddBouquet() {

    viewModel.addBouquet(bouquetsTableView.getSelectionModel().getSelectedItem());
  }

  @FXML
  private void handleAddAccessory() {

    viewModel.addAccessory(accessoriesTableView.getSelectionModel().getSelectedItem());
  }

  @FXML
  private void handleRemoveItem() {

    viewModel.removeItem(orderItemsTableView.getSelectionModel().getSelectedItem());
  }
  ...
  private void handleBack() {
    ...
    try {
      ...
      Stage currentStage = (Stage) orderItemsTableView.getScene().getWindow();
