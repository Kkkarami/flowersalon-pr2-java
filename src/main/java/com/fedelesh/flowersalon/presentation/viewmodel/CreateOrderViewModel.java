...
public class CreateOrderViewModel {
  ...
  public void addFlower(Flower flower) {
    ...
    OrderLineViewModel item =
        new OrderLineViewModel("Flower", flower.getName(), 1, flower.getPrice());
  ...
  public void addBouquet(Bouquet bouquet) {
    ...
    OrderLineViewModel item =
        new OrderLineViewModel("Bouquet", bouquet.getName(), 1, BigDecimal.valueOf(500));
  ...
  public void addAccessory(Accessory accessory) {
    ...
    OrderLineViewModel item =
        new OrderLineViewModel("Accessory", accessory.getName(), 1, accessory.getPrice());
    ...
    for (OrderItem item : items) {
      ...
      OrderLineViewModel vm =
          new OrderLineViewModel(
              item.getItemType(), name, item.getQuantity(), item.getPriceSnapshot());
