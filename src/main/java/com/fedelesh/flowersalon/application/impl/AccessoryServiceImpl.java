...
public class AccessoryServiceImpl implements AccessoryService {
  ...
  private void validateAccessory(Accessory accessory) {
    new ValidationHelper()
        ...
        .addErrorIf(
            accessory.getAccessoryType() == null, "accessoryType", "Тип аксесуара обов'язковий")
        .addErrorIf(accessory.getPrice() == null, "price", "Ціна обов'язкова")
        .addErrorIf(
            accessory.getPrice() != null && accessory.getPrice().signum() <= 0,
            "price",
            "Ціна має бути більшою за 0")
        .addErrorIf(
            accessory.getStockQuantity() < 0, "stockQuantity", "Кількість не може бути від'ємною")
        .throwIfHasErrors();
  }
}
