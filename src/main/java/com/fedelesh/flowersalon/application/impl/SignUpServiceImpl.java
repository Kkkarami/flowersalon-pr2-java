...
public class SignUpServiceImpl implements SignUpService {
    ...
    public String generateVerificationCode(String email) {
        ...
        new ValidationHelper()
                ...
                .addErrorIf(
                        userRepository.findByEmail(email).isPresent(), "email", "Користувач з такою поштою вже існує")
                .throwIfHasErrors();
    ...
    public void register(
        ...
        helper.notEmpty("firstName", firstName)
        ...
        helper.addErrorIf(userRepository.findByEmail(email).isPresent(), "email", "Користувач вже існує");
        ...
        if (code != null && createdAt != null) {
            ...
            helper.addErrorIf(
                    LocalDateTime.now().isAfter(createdAt.plusMinutes(EXP_MINUTES)), "code", "Код прострочений");
