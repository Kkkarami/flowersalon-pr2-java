...
public class SignUpServiceImpl implements SignUpService {
    ...
    public void register(
        ...
        helper.addErrorIf(code == null || createdAt == null,
              "code",
              "Код не був згенерований"
        );

        helper.addErrorIf(userRepository.findByEmail(email).isPresent(),
              "email",
        ...
        if (code != null && createdAt != null) {
            ...
            helper.addErrorIf(!email.equals(emailForCode),
                  "email",
                  "Пошта не співпадає"
            );
            ...
            helper.addErrorIf(!code.equals(inputCode),
                  "code",
                  "Невірний код"
            );
        }
