...
public class FlowerServiceImpl implements FlowerService {
    ...
    private void validateFlower(Flower flower) {
        new ValidationHelper()
              ...
              .addErrorIf(flower.getPrice() != null && flower.getPrice().signum() <= 0, "price", "Ціна має бути більшою за 0")
              .addErrorIf(flower.getStockQuantity() < 0, "stockQuantity", "Кількість не може бути від'ємною")
              .throwIfHasErrors();
    }
}
