...
import com.fedelesh.flowersalon.infrastructure.storage.contract.BouquetAccessoryRepository;
...
public class BouquetAccessoryRepositoryImpl
      extends BaseRepository<BouquetAccessory> implements BouquetAccessoryRepository {
    ...
    @Override
    protected void setInsertParams(PreparedStatement stmt, BouquetAccessory b)
          throws SQLException {
    ...
    @Override
    protected void setUpdateParams(PreparedStatement stmt, BouquetAccessory b)
          throws SQLException {
