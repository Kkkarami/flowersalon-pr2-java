...
import com.fedelesh.flowersalon.infrastructure.storage.contract.OrderItemRepository;
...
public class OrderItemRepositoryImpl extends BaseRepository<OrderItem> implements
      OrderItemRepository {
