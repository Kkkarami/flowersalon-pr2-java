...
import com.fedelesh.flowersalon.infrastructure.persistence.contract.BouquetItemRepository;
...
public class BouquetItemRepositoryImpl extends BaseRepository<BouquetItem> implements BouquetItemRepository {
    ...
    @Override
    protected void setInsertParams(PreparedStatement stmt, BouquetItem b) throws SQLException {
    ...
    @Override
    protected void setUpdateParams(PreparedStatement stmt, BouquetItem b) throws SQLException {
